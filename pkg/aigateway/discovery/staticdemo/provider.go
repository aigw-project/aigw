...
// get istio xds server ip:port from enviroment variable; use "" by default
...
// validate and parse the addr, currently only support ipv4
func parseIPv4Port(s string) (string, uint16, bool) {
	re := regexp.MustCompile(ipv4PortRe)
